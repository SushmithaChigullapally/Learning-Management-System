...
function StudentDashboard() {
    ...
    const handleQuizButtonClick = () => {
        ...
        window.open('http://localhost:8501', '_blank'); // Replace with the correct URL if needed
    };
    ...
    return (
        <div>
            ...
            <div className="sidebar">
                {/* Add Quiz button to the sidebar */}
                <button onClick={handleQuizButtonClick} className="quiz-btn">
                    Quiz
                </button>
            </div>
            ...
            <div className='over-afridi'>
                ...
                <div className='green-afridi shadow'>
                    <div className='green-icon'>
                        <svg width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M23 1v18h-3v-1h2V2H2v16h8v1H1V1zm-7 2H8v1h8zm-2 3V5h-4v1zm-7 5H3v1h4zm0 2H3v1h4zm-4 3h2v-1H3zm14-3a2 2 0 1 1-2-2 2.002 2.002 0 0 1 2 2zm-1 0a1 1 0 1 0-1 1 1.001 1.001 0 0 0 1-1zm.002-4.293a.965.965 0 0 0 1.32.55 1.08 1.08 0 0 1 1.213.207 1.066 1.066 0 0 1 .21 1.21.966.966 0 0 0 .548 1.324 1.064 1.064 0 0 1 0 2.004.965.965 0 0 0-.549 1.323A1.05 1.05 0 0 1 18 16.816v7.046l-3-2.538-3 2.538v-7.046a1.05 1.0 1 0 0-.744-1.49.965.965 0 0 0-.549-1.324 1.064 1.064 0 0 1 0-2.004.965.965 0 0 0 1.32-.55zm-3 0a.965.965 0 0 0 1.318.548 1.073 1.073 0 0 1 1.21-.21 1.067 1.067 0 0 1 .21-1.212 1.066 1.066 0 0 1 .549-1.322 1.063 1.063 0 0 1 0-2.004" fill="#000000" /></svg>
                    </div>
                    <div className='text-in-green'>
                        <div className='greendiv-motive'>
                            <p>Ongoing Course</p></div><div className='greendiv-head'>
                            <h3>{overview.in_progress_course} </h3></div>
                    </div>
                </div>
            </div>
        </div>
